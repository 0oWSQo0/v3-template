        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="用户密码" prop="password">
              <el-input v-model="form.password" placeholder="请输入用户密码" type="password" auto-complete="new-password" maxlength="20" show-password />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="用户性别">
              <el-select class="w-full" v-model="form.sex" placeholder="请选择">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="岗位">
              <el-select class="w-full" v-model="form.postIds" multiple placeholder="请选择">

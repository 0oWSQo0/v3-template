  ...
  <div>
    <el-form class="queryForm" v-show="showSearch" ref="queryRef" :model="queryParams" :inline="true" label-width="68px">
      <el-form-item label="系统模块" prop="title">
        <el-input v-model="queryParams.title" placeholder="请输入系统模块" clearable maxlength="30" @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="操作人员" prop="operName">
        <el-input v-model="queryParams.operName" placeholder="请输入操作人员" clearable maxlength="30" @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-table border show-overflow-tooltip ref="operlogRef" v-loading="loading" :data="list" :default-sort="defaultSort" @selectionChange="handleSelectionChange" @sortChange="handleSortChange">
      ...
      <el-table-column label="操作人员" align="center" width="110" prop="operName" sortable="custom" :sort-orders="['descending', 'ascending']" />
      <el-table-column label="主机" align="center" prop="operIp" width="150" />
      ...
      <el-table-column label="消耗时间" align="center" prop="costTime" width="110" sortable="custom" :sort-orders="['descending', 'ascending']" :formatter="row => row.costTime + '毫秒'" />
      <el-table-column label="操作" align="center" width="90">
        <template #default="{ row }">
          <el-button v-hasPermi="['monitor:operlog:query']" link type="primary" icon="View" @click="handleView(row)">详细</el-button>
        </template>
      </el-table-column>
    </el-table>
